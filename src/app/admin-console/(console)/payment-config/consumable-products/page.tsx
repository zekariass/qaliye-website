              ...
              {items.map((item) => (
                <tr key={item.id} className="hover:bg-[#F7F7FA]">
                  ...
                  <td className="px-4 py-3 font-medium text-[#17171B]">
                    <Link href={`${adminConsolePath}/payment-config/consumable-products/${item.id}`} className="hover:text-[#7C3AED] hover:underline">
                      {item.name}
                    </Link>
                  </td>
                  ...
                  <td className="px-4 py-3">
                    <div className="flex gap-1.5 justify-end">
                      <Link href={`${adminConsolePath}/payment-config/consumable-products/${item.id}`} className="p-1.5 text-[#666672] hover:text-[#7C3AED] hover:bg-[#EDE2FF] rounded-lg" title="View details"><Eye className="h-3.5 w-3.5" /></Link>
